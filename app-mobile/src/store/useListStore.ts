...
const SAMPLE_LISTS: ShoppingList[] = [
  {
    ...
    items: [
      { id: 1, name: 'Leite', completed: true, quantity: 2, price: 4.50 },
      { id: 2, name: 'Pão', completed: true, quantity: 1, price: 6.00 },
      { id: 3, name: 'Ovos', completed: false, quantity: 2, price: 12.90 },
      { id: 4, name: 'Manteiga', completed: false },
      { id: 5, name: 'Queijo', completed: false, quantity: 1, price: 25.00 },
      { id: 6, name: 'Iogurte', completed: false, quantity: 4, price: 3.50 },
